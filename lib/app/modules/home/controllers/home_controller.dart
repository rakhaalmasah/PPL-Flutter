...
class HomeController extends GetxController {
  ...
  Future<void> fetchStocks() async {
    const url = 'https://ppl-cloud-computing-447282078912.asia-southeast2.run.app/stocks';
    try {
  ...
  Future<void> fetchStockDetail(String code) async {
    final url = 'https://ppl-cloud-computing-447282078912.asia-southeast2.run.app/stocks/$code';
    try {
      final response = await http.get(Uri.parse(url));
      if (response.statusCode == 200) {
